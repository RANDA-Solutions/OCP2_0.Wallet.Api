...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.Models.Credentials.SearchCredentialPackageCredentialTypeViewModel", b =>
                {
                    ...
                    b.ToView("SearchCredentialPackageCredentialTypesView", "cred");
                });

            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.Models.Credentials.SearchCredentialPackageIssuerViewModel", b =>
                {
                    b.Property<int>("CredentialPackageId")
                        .HasColumnType("int");
                    ...
                    b.ToView("SearchCredentialPackageIssuersView", "cred");
                });

            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.Models.Credentials.SearchCredentialPackageModel", b =>
                {
                    b.Property<int>("CredentialPackageId")
                        .HasColumnType("int");
                    ...
                    b.ToView("SearchCredentialPackagesView", "cred");
                });

            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.CredentialPackage", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CreateTimestamp")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 445, DateTimeKind.Unspecified).AddTicks(4432), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset?>("IssuanceDate")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("ModifiedTimestamp")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 445, DateTimeKind.Unspecified).AddTicks(4767), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Profile", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 446, DateTimeKind.Unspecified).AddTicks(1246), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 446, DateTimeKind.Unspecified).AddTicks(1625), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.VerifiableCredential", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 446, DateTimeKind.Unspecified).AddTicks(3707), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 17, 36, 47, 446, DateTimeKind.Unspecified).AddTicks(4032), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Models.ETS.Folio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.Models.Credentials.SearchCredentialPackageCredentialTypeViewModel", b =>
                {
                    b.HasOne("OpenCredentialPublisher.Data.Custom.Models.Credentials.SearchCredentialPackageModel", null)
                        .WithMany("CredentialTypes")
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Models.ETS.Test", b =>
                {
                    ...
                    b.HasOne("OpenCredentialPublisher.Data.Models.ETS.Folio", null)
                        .WithMany("Tests")
