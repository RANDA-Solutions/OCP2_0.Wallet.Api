...
namespace OpenCredentialPublisher.Data.Custom.Migrations
{
    ...
    [Migration("20250424221354_Clr2Associations")]
    partial class Clr2Associations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Association", b =>
                {
                    ...
                    b.Property<long>("SourceVerifiableCredentialId")
                        .HasColumnType("bigint");

                    b.Property<long>("TargetVerifiableCredentialId")
                        .HasColumnType("bigint");

                    b.HasKey("AssociationId");

                    b.HasIndex("SourceVerifiableCredentialId");

                    b.HasIndex("TargetVerifiableCredentialId");

                    b.ToTable("Association", "cred2");
                });
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Result", b =>
                {
                    ...
                    b.Property<string>("ResultDescriptionName")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ResultDescriptionType")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Setup", b =>
                {
                    b.Property<long>("SetupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("SetupId"));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Association", b =>
                {
                    b.HasOne("OpenCredentialPublisher.Data.Custom.EFModels.VerifiableCredential", "SourceVerifiableCredential")
                        .WithMany("SourceAssociations")
                        .HasForeignKey("SourceVerifiableCredentialId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("OpenCredentialPublisher.Data.Custom.EFModels.VerifiableCredential", "TargetVerifiableCredential")
                        .WithMany("TargetAssociations")
                        .HasForeignKey("TargetVerifiableCredentialId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SourceVerifiableCredential");

                    b.Navigation("TargetVerifiableCredential");
                });
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Setup", b =>
                {
                    b.HasOne("OpenCredentialPublisher.Data.Custom.EFModels.Message", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.VerifiableCredential", b =>
                {
                    ...
                    b.Navigation("SourceAssociations");

                    b.Navigation("TargetAssociations");
                });
