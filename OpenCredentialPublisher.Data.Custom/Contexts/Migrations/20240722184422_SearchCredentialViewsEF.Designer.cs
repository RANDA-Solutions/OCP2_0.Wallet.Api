...
namespace OpenCredentialPublisher.Data.Custom.Migrations
{
    ...
    [Migration("20240722184422_SearchCredentialViewsEF")]
    partial class SearchCredentialViewsEF
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.SearchCredentialAchievementType", b =>
                {
                    b.Property<long>("VerifiableCredentialId")
                        .HasColumnType("bigint");
                    ...
                    b.ToView("SearchCredentialAchievementTypeView", "cred2");
                });
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.SearchCredentialIssuer", b =>
                {
                    b.Property<long>("VerifiableCredentialId")
                        .HasColumnType("bigint");
                    ...
                    b.ToView("SearchCredentialIssuerView", "cred2");
                });
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.SearchCredentialAchievementType", b =>
                {
                    b.HasOne("OpenCredentialPublisher.Data.Custom.EFModels.SearchCredential", null)
