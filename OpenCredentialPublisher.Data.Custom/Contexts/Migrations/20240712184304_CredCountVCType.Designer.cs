...
namespace OpenCredentialPublisher.Data.Custom.Migrations
{
    ...
    [Migration("20240712184304_CredCountVCType")]
    partial class CredCountVCType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.CredentialPackage", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CreateTimestamp")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 632, DateTimeKind.Unspecified).AddTicks(2956), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset?>("ModifiedTimestamp")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 632, DateTimeKind.Unspecified).AddTicks(3446), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.Profile", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 632, DateTimeKind.Unspecified).AddTicks(9417), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 632, DateTimeKind.Unspecified).AddTicks(9719), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("OpenCredentialPublisher.Data.Custom.EFModels.VerifiableCredential", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 633, DateTimeKind.Unspecified).AddTicks(1797), new TimeSpan(0, 0, 0, 0, 0)));
                    ...
                    b.Property<DateTimeOffset>("ModifiedTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2024, 7, 12, 18, 43, 3, 633, DateTimeKind.Unspecified).AddTicks(2115), new TimeSpan(0, 0, 0, 0, 0)));
