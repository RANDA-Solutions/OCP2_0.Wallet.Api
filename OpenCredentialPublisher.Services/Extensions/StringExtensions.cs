...
namespace OpenCredentialPublisher.Services.Extensions
{
    public static class StringExtensions
    {
        ...
        public static DateTimeOffset ToDateTimeOffsetOrDefault(this string dateTimeString, DateTimeOffset defaultValue)
        {
            if (string.IsNullOrEmpty(dateTimeString) || !DateTimeOffset.TryParse(dateTimeString, out DateTimeOffset result))
            {
                return defaultValue;
            }
            return result;
